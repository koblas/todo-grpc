...
func NewAuthenticationServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) AuthenticationService {
	...
	serviceURL += baseServicePath(pathPrefix, "api.auth", "AuthenticationService")
	urls := [8]string{
		serviceURL + "Register",
		serviceURL + "Authenticate",
		serviceURL + "VerifyEmail",
		serviceURL + "RecoverSend",
		serviceURL + "RecoverVerify",
		serviceURL + "RecoverUpdate",
		serviceURL + "OauthLogin",
		serviceURL + "OauthUrl",
	}
	if literalURLs {
		urls = [8]string{
			serviceURL + "register",
			serviceURL + "authenticate",
			serviceURL + "verify_email",
			serviceURL + "recover_send",
			serviceURL + "recover_verify",
			serviceURL + "recover_update",
			serviceURL + "oauth_login",
			serviceURL + "oauth_url",
		}
	}
...
func (c *authenticationServiceProtobufClient) Register(ctx context.Context, in *RegisterParams) (*TokenRegister, error) {
	ctx = ctxsetters.WithPackageName(ctx, "api.auth")
...
const AuthenticationServicePathPrefix = "/twirp/api.auth.AuthenticationService/"
...
func (s *authenticationServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "api.auth.AuthenticationService" {
	...
	case "authenticate", "Authenticate":
		...
		return
	case "verify_email", "VerifyEmail":
		s.serveVerifyEmail(ctx, resp, req)
		return
	case "recover_send", "RecoverSend":
		s.serveRecoverSend(ctx, resp, req)
		return
	case "recover_verify", "RecoverVerify":
		s.serveRecoverVerify(ctx, resp, req)
		return
	case "recover_update", "RecoverUpdate":
		s.serveRecoverUpdate(ctx, resp, req)
		return
	case "oauth_login", "OauthLogin":
		s.serveOauthLogin(ctx, resp, req)
		return
	case "oauth_url", "OauthUrl":
		s.serveOauthUrl(ctx, resp, req)
		return
	default:
		msg := fmt.Sprintf("no handler for path %q", req.URL.Path)
		s.writeError(ctx, resp, badRouteError(msg, req.Method, req.URL.Path))
...
func (s *authenticationServiceServer) serveAuthenticate(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *authenticationServiceServer) serveAuthenticateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Authenticate")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveAuthenticateProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Authenticate")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveVerifyEmail(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *authenticationServiceServer) serveVerifyEmailJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "VerifyEmail")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveVerifyEmailProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "VerifyEmail")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveRecoverSend(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveRecoverSendJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveRecoverSendProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *authenticationServiceServer) serveRecoverSendJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RecoverSend")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveRecoverSendProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RecoverSend")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveRecoverVerify(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveRecoverVerifyJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveRecoverVerifyProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *authenticationServiceServer) serveRecoverVerifyJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RecoverVerify")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveRecoverVerifyProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RecoverVerify")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveRecoverUpdate(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveRecoverUpdateJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveRecoverUpdateProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *authenticationServiceServer) serveRecoverUpdateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RecoverUpdate")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveRecoverUpdateProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RecoverUpdate")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveOauthLogin(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveOauthLoginJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveOauthLoginProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *authenticationServiceServer) serveOauthLoginJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "OauthLogin")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveOauthLoginProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "OauthLogin")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveOauthUrl(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveOauthUrlJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveOauthUrlProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *authenticationServiceServer) serveOauthUrlJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "OauthUrl")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveOauthUrlProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "OauthUrl")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "api.auth", "AuthenticationService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
