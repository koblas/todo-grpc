...
import (
	...
	v1 "github.com/koblas/grpc-todo/gen/api/todo/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TodoServiceName = "api.todo.v1.TodoService"
)

// TodoServiceClient is a client for the api.todo.v1.TodoService service.
...
// NewTodoServiceClient constructs a client for the api.todo.v1.TodoService service. By default, it
...
// TodoAdd calls api.todo.v1.TodoService.todo_add.
...
// TodoDelete calls api.todo.v1.TodoService.todo_delete.
...
// TodoList calls api.todo.v1.TodoService.todo_list.
...
// TodoServiceHandler is an implementation of the api.todo.v1.TodoService service.
...
func NewTodoServiceHandler(svc TodoServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/api.todo.v1.TodoService/todo_add", connect_go.NewUnaryHandler(
		"/api.todo.v1.TodoService/todo_add",
		svc.TodoAdd,
		opts...,
	))
	mux.Handle("/api.todo.v1.TodoService/todo_delete", connect_go.NewUnaryHandler(
		"/api.todo.v1.TodoService/todo_delete",
		svc.TodoDelete,
		opts...,
	))
	mux.Handle("/api.todo.v1.TodoService/todo_list", connect_go.NewUnaryHandler(
		"/api.todo.v1.TodoService/todo_list",
		svc.TodoList,
		opts...,
	))
	return "/api.todo.v1.TodoService/", mux
}
...
func (UnimplementedTodoServiceHandler) TodoAdd(context.Context, *connect_go.Request[v1.TodoAddRequest]) (*connect_go.Response[v1.TodoAddResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.todo.v1.TodoService.todo_add is not implemented"))
}
...
func (UnimplementedTodoServiceHandler) TodoDelete(context.Context, *connect_go.Request[v1.TodoDeleteRequest]) (*connect_go.Response[v1.TodoDeleteResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.todo.v1.TodoService.todo_delete is not implemented"))
}
...
func (UnimplementedTodoServiceHandler) TodoList(context.Context, *connect_go.Request[v1.TodoListRequest]) (*connect_go.Response[v1.TodoListResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.todo.v1.TodoService.todo_list is not implemented"))
}
