...
const (
	...
	GptServiceName = "api.v1.GptService"
)

// GptServiceClient is a client for the api.v1.GptService service.
...
// NewGptServiceClient constructs a client for the api.v1.GptService service. By default, it uses
...
func NewGptServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GptServiceClient {
	...
	return &gptServiceClient{
		create: connect_go.NewClient[v1.GptServiceCreateRequest, v1.GptServiceCreateResponse](
			httpClient,
			baseURL+"/api.v1.GptService/create",
			opts...,
		),
	}
}
...
// Create calls api.v1.GptService.create.
...
// GptServiceHandler is an implementation of the api.v1.GptService service.
...
func NewGptServiceHandler(svc GptServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/api.v1.GptService/create", connect_go.NewUnaryHandler(
		"/api.v1.GptService/create",
		svc.Create,
		opts...,
	))
	return "/api.v1.GptService/", mux
}
...
func (UnimplementedGptServiceHandler) Create(context.Context, *connect_go.Request[v1.GptServiceCreateRequest]) (*connect_go.Response[v1.GptServiceCreateResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1.GptService.create is not implemented"))
}
