...
import (
	...
	v1 "github.com/koblas/grpc-todo/gen/api/file/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	FileServiceName = "api.file.v1.FileService"
)

// FileServiceClient is a client for the api.file.v1.FileService service.
...
// NewFileServiceClient constructs a client for the api.file.v1.FileService service. By default, it
...
func NewFileServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) FileServiceClient {
	...
	return &fileServiceClient{
		uploadUrl: connect_go.NewClient[v1.FileServiceUploadUrlRequest, v1.FileServiceUploadUrlResponse](
			httpClient,
			baseURL+"/api.file.v1.FileService/upload_url",
			opts...,
		),
	}
}
...
// UploadUrl calls api.file.v1.FileService.upload_url.
...
// FileServiceHandler is an implementation of the api.file.v1.FileService service.
...
func NewFileServiceHandler(svc FileServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/api.file.v1.FileService/upload_url", connect_go.NewUnaryHandler(
		"/api.file.v1.FileService/upload_url",
		svc.UploadUrl,
		opts...,
	))
	return "/api.file.v1.FileService/", mux
}
...
func (UnimplementedFileServiceHandler) UploadUrl(context.Context, *connect_go.Request[v1.FileServiceUploadUrlRequest]) (*connect_go.Response[v1.FileServiceUploadUrlResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.file.v1.FileService.upload_url is not implemented"))
}
