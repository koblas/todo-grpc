...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/todo/v1/todov1connect.TodoServiceClient -o ./todo_service_client_mock.go -n TodoServiceClientMock
