...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/eventbus/v1/eventbusv1connect.TodoEventbusServiceHandler -o ./todo_eventbus_service_handler_mock.go -n TodoEventbusServiceHandlerMock
...
func (mmTodoChange *mTodoEventbusServiceHandlerMockTodoChange) Return(pp2 *connect_go.Response[v11.TodoEventbusTodoChangeResponse], err error) *TodoEventbusServiceHandlerMock {
	if mmTodoChange.mock.funcTodoChange != nil {
		mmTodoChange.mock.t.Fatalf("TodoEventbusServiceHandlerMock.TodoChange mock is already set by Set")
	}
...
func (e *TodoEventbusServiceHandlerMockTodoChangeExpectation) Then(pp2 *connect_go.Response[v11.TodoEventbusTodoChangeResponse], err error) *TodoEventbusServiceHandlerMock {
