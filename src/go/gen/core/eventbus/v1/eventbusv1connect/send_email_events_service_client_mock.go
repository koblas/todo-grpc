...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/eventbus/v1/eventbusv1connect.SendEmailEventsServiceClient -o ./send_email_events_service_client_mock.go -n SendEmailEventsServiceClientMock
...
func (mmNotifyEmailSent *mSendEmailEventsServiceClientMockNotifyEmailSent) Expect(ctx context.Context, pp1 *connect_go.Request[v11.NotifyEmailSentRequest]) *mSendEmailEventsServiceClientMockNotifyEmailSent {
...
func (mmNotifyEmailSent *mSendEmailEventsServiceClientMockNotifyEmailSent) Inspect(f func(ctx context.Context, pp1 *connect_go.Request[v11.NotifyEmailSentRequest])) *mSendEmailEventsServiceClientMockNotifyEmailSent {
...
func (mmNotifyEmailSent *mSendEmailEventsServiceClientMockNotifyEmailSent) Return(pp2 *connect_go.Response[v11.NotifyEmailSentResponse], err error) *SendEmailEventsServiceClientMock {
	if mmNotifyEmailSent.mock.funcNotifyEmailSent != nil {
		mmNotifyEmailSent.mock.t.Fatalf("SendEmailEventsServiceClientMock.NotifyEmailSent mock is already set by Set")
	}
...
func (mmNotifyEmailSent *mSendEmailEventsServiceClientMockNotifyEmailSent) Set(f func(ctx context.Context, pp1 *connect_go.Request[v11.NotifyEmailSentRequest]) (pp2 *connect_go.Response[v11.NotifyEmailSentResponse], err error)) *SendEmailEventsServiceClientMock {
	if mmNotifyEmailSent.defaultExpectation != nil {
...
// Then helper
func (mmNotifyEmailSent *mSendEmailEventsServiceClientMockNotifyEmailSent) When(ctx context.Context, pp1 *connect_go.Request[v11.NotifyEmailSentRequest]) *SendEmailEventsServiceClientMockNotifyEmailSentExpectation {
	if mmNotifyEmailSent.mock.funcNotifyEmailSent != nil {
		mmNotifyEmailSent.mock.t.Fatalf("SendEmailEventsServiceClientMock.NotifyEmailSent mock is already set by Set")
	}
...
func (e *SendEmailEventsServiceClientMockNotifyEmailSentExpectation) Then(pp2 *connect_go.Response[v11.NotifyEmailSentResponse], err error) *SendEmailEventsServiceClientMock {
...
func (mmNotifyEmailSent *SendEmailEventsServiceClientMock) NotifyEmailSent(ctx context.Context, pp1 *connect_go.Request[v11.NotifyEmailSentRequest]) (pp2 *connect_go.Response[v11.NotifyEmailSentResponse], err error) {
