...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.UserServiceHandler -o ./user_service_handler_mock_test.go -n UserServiceHandlerMock
