...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.MessageEventbusServiceClient -o ./message_eventbus_service_client_mock.go -n MessageEventbusServiceClientMock
...
func (mmChange *mMessageEventbusServiceClientMockChange) Expect(ctx context.Context, pp1 *connect_go.Request[v11.MessageChangeEvent]) *mMessageEventbusServiceClientMockChange {
...
func (mmChange *mMessageEventbusServiceClientMockChange) Inspect(f func(ctx context.Context, pp1 *connect_go.Request[v11.MessageChangeEvent])) *mMessageEventbusServiceClientMockChange {
...
func (mmChange *mMessageEventbusServiceClientMockChange) Return(pp2 *connect_go.Response[v1.MessageEventbusServiceChangeResponse], err error) *MessageEventbusServiceClientMock {
	if mmChange.mock.funcChange != nil {
		mmChange.mock.t.Fatalf("MessageEventbusServiceClientMock.Change mock is already set by Set")
	}
...
func (mmChange *mMessageEventbusServiceClientMockChange) Set(f func(ctx context.Context, pp1 *connect_go.Request[v11.MessageChangeEvent]) (pp2 *connect_go.Response[v1.MessageEventbusServiceChangeResponse], err error)) *MessageEventbusServiceClientMock {
	if mmChange.defaultExpectation != nil {
...
// Then helper
func (mmChange *mMessageEventbusServiceClientMockChange) When(ctx context.Context, pp1 *connect_go.Request[v11.MessageChangeEvent]) *MessageEventbusServiceClientMockChangeExpectation {
	if mmChange.mock.funcChange != nil {
		mmChange.mock.t.Fatalf("MessageEventbusServiceClientMock.Change mock is already set by Set")
	}
...
func (e *MessageEventbusServiceClientMockChangeExpectation) Then(pp2 *connect_go.Response[v1.MessageEventbusServiceChangeResponse], err error) *MessageEventbusServiceClientMock {
	e.results = &MessageEventbusServiceClientMockChangeResults{pp2, err}
	return e.mock
}

// Change implements MessageEventbusServiceClient
func (mmChange *MessageEventbusServiceClientMock) Change(ctx context.Context, pp1 *connect_go.Request[v11.MessageChangeEvent]) (pp2 *connect_go.Response[v1.MessageEventbusServiceChangeResponse], err error) {
