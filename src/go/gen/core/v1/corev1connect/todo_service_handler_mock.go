...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.TodoServiceHandler -o ./todo_service_handler_mock.go -n TodoServiceHandlerMock
