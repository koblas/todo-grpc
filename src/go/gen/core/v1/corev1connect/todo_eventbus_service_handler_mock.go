...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.TodoEventbusServiceHandler -o ./todo_eventbus_service_handler_mock.go -n TodoEventbusServiceHandlerMock
