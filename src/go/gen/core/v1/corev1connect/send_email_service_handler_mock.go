...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.SendEmailServiceHandler -o ./send_email_service_handler_mock.go -n SendEmailServiceHandlerMock
