...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.SendEmailEventsServiceClient -o ./send_email_events_service_client_mock.go -n SendEmailEventsServiceClientMock
