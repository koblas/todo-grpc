...
const (
	...
	TodoServiceName = "core.v1.TodoService"
)

// TodoServiceClient is a client for the core.v1.TodoService service.
...
// NewTodoServiceClient constructs a client for the core.v1.TodoService service. By default, it uses
...
// TodoAdd calls core.v1.TodoService.TodoAdd.
...
// TodoDelete calls core.v1.TodoService.TodoDelete.
...
// TodoList calls core.v1.TodoService.TodoList.
...
// TodoServiceHandler is an implementation of the core.v1.TodoService service.
...
func NewTodoServiceHandler(svc TodoServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/core.v1.TodoService/TodoAdd", connect_go.NewUnaryHandler(
		"/core.v1.TodoService/TodoAdd",
		svc.TodoAdd,
		opts...,
	))
	mux.Handle("/core.v1.TodoService/TodoDelete", connect_go.NewUnaryHandler(
		"/core.v1.TodoService/TodoDelete",
		svc.TodoDelete,
		opts...,
	))
	mux.Handle("/core.v1.TodoService/TodoList", connect_go.NewUnaryHandler(
		"/core.v1.TodoService/TodoList",
		svc.TodoList,
		opts...,
	))
	return "/core.v1.TodoService/", mux
}
...
func (UnimplementedTodoServiceHandler) TodoAdd(context.Context, *connect_go.Request[v1.TodoAddRequest]) (*connect_go.Response[v1.TodoAddResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.TodoService.TodoAdd is not implemented"))
}
...
func (UnimplementedTodoServiceHandler) TodoDelete(context.Context, *connect_go.Request[v1.TodoDeleteRequest]) (*connect_go.Response[v1.TodoDeleteResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.TodoService.TodoDelete is not implemented"))
}
...
func (UnimplementedTodoServiceHandler) TodoList(context.Context, *connect_go.Request[v1.TodoListRequest]) (*connect_go.Response[v1.TodoListResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.TodoService.TodoList is not implemented"))
}
