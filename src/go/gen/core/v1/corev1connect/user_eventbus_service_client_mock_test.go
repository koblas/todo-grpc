...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.UserEventbusServiceClient -o ./user_eventbus_service_client_mock_test.go -n UserEventbusServiceClientMock
...
func (mmSecurityForgotRequest *mUserEventbusServiceClientMockSecurityForgotRequest) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error) *UserEventbusServiceClientMock {
	if mmSecurityForgotRequest.mock.funcSecurityForgotRequest != nil {
		mmSecurityForgotRequest.mock.t.Fatalf("UserEventbusServiceClientMock.SecurityForgotRequest mock is already set by Set")
	}
...
func (mmSecurityForgotRequest *mUserEventbusServiceClientMockSecurityForgotRequest) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error)) *UserEventbusServiceClientMock {
	if mmSecurityForgotRequest.defaultExpectation != nil {
...
func (e *UserEventbusServiceClientMockSecurityForgotRequestExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error) *UserEventbusServiceClientMock {
...
func (mmSecurityForgotRequest *UserEventbusServiceClientMock) SecurityForgotRequest(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error) {
...
func (mmSecurityInviteToken *mUserEventbusServiceClientMockSecurityInviteToken) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error) *UserEventbusServiceClientMock {
	if mmSecurityInviteToken.mock.funcSecurityInviteToken != nil {
		mmSecurityInviteToken.mock.t.Fatalf("UserEventbusServiceClientMock.SecurityInviteToken mock is already set by Set")
	}
...
func (mmSecurityInviteToken *mUserEventbusServiceClientMockSecurityInviteToken) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error)) *UserEventbusServiceClientMock {
	if mmSecurityInviteToken.defaultExpectation != nil {
...
func (e *UserEventbusServiceClientMockSecurityInviteTokenExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error) *UserEventbusServiceClientMock {
...
func (mmSecurityInviteToken *UserEventbusServiceClientMock) SecurityInviteToken(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error) {
...
func (mmSecurityPasswordChange *mUserEventbusServiceClientMockSecurityPasswordChange) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error) *UserEventbusServiceClientMock {
	if mmSecurityPasswordChange.mock.funcSecurityPasswordChange != nil {
		mmSecurityPasswordChange.mock.t.Fatalf("UserEventbusServiceClientMock.SecurityPasswordChange mock is already set by Set")
	}
...
func (mmSecurityPasswordChange *mUserEventbusServiceClientMockSecurityPasswordChange) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error)) *UserEventbusServiceClientMock {
	if mmSecurityPasswordChange.defaultExpectation != nil {
...
func (e *UserEventbusServiceClientMockSecurityPasswordChangeExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error) *UserEventbusServiceClientMock {
...
func (mmSecurityPasswordChange *UserEventbusServiceClientMock) SecurityPasswordChange(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error) {
...
func (mmSecurityRegisterToken *mUserEventbusServiceClientMockSecurityRegisterToken) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error) *UserEventbusServiceClientMock {
	if mmSecurityRegisterToken.mock.funcSecurityRegisterToken != nil {
		mmSecurityRegisterToken.mock.t.Fatalf("UserEventbusServiceClientMock.SecurityRegisterToken mock is already set by Set")
	}
...
func (mmSecurityRegisterToken *mUserEventbusServiceClientMockSecurityRegisterToken) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error)) *UserEventbusServiceClientMock {
	if mmSecurityRegisterToken.defaultExpectation != nil {
...
func (e *UserEventbusServiceClientMockSecurityRegisterTokenExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error) *UserEventbusServiceClientMock {
...
func (mmSecurityRegisterToken *UserEventbusServiceClientMock) SecurityRegisterToken(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error) {
...
func (mmUserChange *mUserEventbusServiceClientMockUserChange) Return(pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error) *UserEventbusServiceClientMock {
	if mmUserChange.mock.funcUserChange != nil {
		mmUserChange.mock.t.Fatalf("UserEventbusServiceClientMock.UserChange mock is already set by Set")
	}
...
func (mmUserChange *mUserEventbusServiceClientMockUserChange) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserChangeEvent]) (pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error)) *UserEventbusServiceClientMock {
	if mmUserChange.defaultExpectation != nil {
...
func (e *UserEventbusServiceClientMockUserChangeExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error) *UserEventbusServiceClientMock {
	e.results = &UserEventbusServiceClientMockUserChangeResults{pp2, err}
	return e.mock
}

// UserChange implements UserEventbusServiceClient
func (mmUserChange *UserEventbusServiceClientMock) UserChange(ctx context.Context, pp1 *connect_go.Request[v1.UserChangeEvent]) (pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error) {
