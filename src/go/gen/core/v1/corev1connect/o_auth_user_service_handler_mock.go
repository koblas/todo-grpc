...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.OAuthUserServiceHandler -o ./o_auth_user_service_handler_mock.go -n OAuthUserServiceHandlerMock
