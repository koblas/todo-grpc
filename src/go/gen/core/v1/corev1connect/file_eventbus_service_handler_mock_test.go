...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.FileEventbusServiceHandler -o ./file_eventbus_service_handler_mock_test.go -n FileEventbusServiceHandlerMock
