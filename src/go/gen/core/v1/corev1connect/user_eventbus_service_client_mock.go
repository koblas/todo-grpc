...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.UserEventbusServiceClient -o ./user_eventbus_service_client_mock.go -n UserEventbusServiceClientMock
