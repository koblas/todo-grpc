...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.UserServiceClient -o ./user_service_client_mock_test.go -n UserServiceClientMock
