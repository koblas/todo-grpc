...
const (
	...
	FileServiceName = "core.v1.FileService"
)

// FileServiceClient is a client for the core.v1.FileService service.
...
// NewFileServiceClient constructs a client for the core.v1.FileService service. By default, it uses
...
// UploadUrl calls core.v1.FileService.UploadUrl.
...
// VerifyUrl calls core.v1.FileService.VerifyUrl.
...
// Upload calls core.v1.FileService.Upload.
...
// Put calls core.v1.FileService.Put.
...
// Get calls core.v1.FileService.Get.
...
// FileServiceHandler is an implementation of the core.v1.FileService service.
...
func NewFileServiceHandler(svc FileServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/core.v1.FileService/UploadUrl", connect_go.NewUnaryHandler(
		"/core.v1.FileService/UploadUrl",
		svc.UploadUrl,
		opts...,
	))
	mux.Handle("/core.v1.FileService/VerifyUrl", connect_go.NewUnaryHandler(
		"/core.v1.FileService/VerifyUrl",
		svc.VerifyUrl,
		opts...,
	))
	mux.Handle("/core.v1.FileService/Upload", connect_go.NewUnaryHandler(
		"/core.v1.FileService/Upload",
		svc.Upload,
		opts...,
	))
	mux.Handle("/core.v1.FileService/Put", connect_go.NewUnaryHandler(
		"/core.v1.FileService/Put",
		svc.Put,
		opts...,
	))
	mux.Handle("/core.v1.FileService/Get", connect_go.NewUnaryHandler(
		"/core.v1.FileService/Get",
		svc.Get,
		opts...,
	))
	return "/core.v1.FileService/", mux
}
...
func (UnimplementedFileServiceHandler) UploadUrl(context.Context, *connect_go.Request[v1.FileServiceUploadUrlRequest]) (*connect_go.Response[v1.FileServiceUploadUrlResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.FileService.UploadUrl is not implemented"))
}
...
func (UnimplementedFileServiceHandler) VerifyUrl(context.Context, *connect_go.Request[v1.FileServiceVerifyUrlRequest]) (*connect_go.Response[v1.FileServiceVerifyUrlResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.FileService.VerifyUrl is not implemented"))
}
...
func (UnimplementedFileServiceHandler) Upload(context.Context, *connect_go.Request[v1.FileServiceUploadRequest]) (*connect_go.Response[v1.FileServiceUploadResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.FileService.Upload is not implemented"))
}
...
func (UnimplementedFileServiceHandler) Put(context.Context, *connect_go.Request[v1.FileServicePutRequest]) (*connect_go.Response[v1.FileServicePutResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.FileService.Put is not implemented"))
}
...
func (UnimplementedFileServiceHandler) Get(context.Context, *connect_go.Request[v1.FileServiceGetRequest]) (*connect_go.Response[v1.FileServiceGetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("core.v1.FileService.Get is not implemented"))
}
