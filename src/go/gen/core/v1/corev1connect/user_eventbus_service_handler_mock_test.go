...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.UserEventbusServiceHandler -o ./user_eventbus_service_handler_mock_test.go -n UserEventbusServiceHandlerMock
...
type UserEventbusServiceHandlerMock struct {
	...
	funcSecurityForgotRequest          func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error)
	...
	funcSecurityInviteToken          func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error)
	...
	funcSecurityPasswordChange          func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error)
	...
	funcSecurityRegisterToken          func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error)
	...
	funcUserChange          func(ctx context.Context, pp1 *connect_go.Request[v1.UserChangeEvent]) (pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error)
...
type UserEventbusServiceHandlerMockSecurityForgotRequestResults struct {
	pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse]
	err error
}
...
func (mmSecurityForgotRequest *mUserEventbusServiceHandlerMockSecurityForgotRequest) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error) *UserEventbusServiceHandlerMock {
	if mmSecurityForgotRequest.mock.funcSecurityForgotRequest != nil {
		mmSecurityForgotRequest.mock.t.Fatalf("UserEventbusServiceHandlerMock.SecurityForgotRequest mock is already set by Set")
	}
...
func (mmSecurityForgotRequest *mUserEventbusServiceHandlerMockSecurityForgotRequest) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error)) *UserEventbusServiceHandlerMock {
	if mmSecurityForgotRequest.defaultExpectation != nil {
...
func (e *UserEventbusServiceHandlerMockSecurityForgotRequestExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error) *UserEventbusServiceHandlerMock {
...
func (mmSecurityForgotRequest *UserEventbusServiceHandlerMock) SecurityForgotRequest(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityForgotRequestResponse], err error) {
...
type UserEventbusServiceHandlerMockSecurityInviteTokenResults struct {
	pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse]
	err error
}
...
func (mmSecurityInviteToken *mUserEventbusServiceHandlerMockSecurityInviteToken) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error) *UserEventbusServiceHandlerMock {
	if mmSecurityInviteToken.mock.funcSecurityInviteToken != nil {
		mmSecurityInviteToken.mock.t.Fatalf("UserEventbusServiceHandlerMock.SecurityInviteToken mock is already set by Set")
	}
...
func (mmSecurityInviteToken *mUserEventbusServiceHandlerMockSecurityInviteToken) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error)) *UserEventbusServiceHandlerMock {
	if mmSecurityInviteToken.defaultExpectation != nil {
...
func (e *UserEventbusServiceHandlerMockSecurityInviteTokenExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error) *UserEventbusServiceHandlerMock {
...
func (mmSecurityInviteToken *UserEventbusServiceHandlerMock) SecurityInviteToken(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityInviteTokenResponse], err error) {
...
type UserEventbusServiceHandlerMockSecurityPasswordChangeResults struct {
	pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse]
	err error
}
...
func (mmSecurityPasswordChange *mUserEventbusServiceHandlerMockSecurityPasswordChange) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error) *UserEventbusServiceHandlerMock {
	if mmSecurityPasswordChange.mock.funcSecurityPasswordChange != nil {
		mmSecurityPasswordChange.mock.t.Fatalf("UserEventbusServiceHandlerMock.SecurityPasswordChange mock is already set by Set")
	}
...
func (mmSecurityPasswordChange *mUserEventbusServiceHandlerMockSecurityPasswordChange) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error)) *UserEventbusServiceHandlerMock {
	if mmSecurityPasswordChange.defaultExpectation != nil {
...
func (e *UserEventbusServiceHandlerMockSecurityPasswordChangeExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error) *UserEventbusServiceHandlerMock {
...
func (mmSecurityPasswordChange *UserEventbusServiceHandlerMock) SecurityPasswordChange(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityPasswordChangeResponse], err error) {
...
type UserEventbusServiceHandlerMockSecurityRegisterTokenResults struct {
	pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse]
	err error
}
...
func (mmSecurityRegisterToken *mUserEventbusServiceHandlerMockSecurityRegisterToken) Return(pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error) *UserEventbusServiceHandlerMock {
	if mmSecurityRegisterToken.mock.funcSecurityRegisterToken != nil {
		mmSecurityRegisterToken.mock.t.Fatalf("UserEventbusServiceHandlerMock.SecurityRegisterToken mock is already set by Set")
	}
...
func (mmSecurityRegisterToken *mUserEventbusServiceHandlerMockSecurityRegisterToken) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error)) *UserEventbusServiceHandlerMock {
	if mmSecurityRegisterToken.defaultExpectation != nil {
...
func (e *UserEventbusServiceHandlerMockSecurityRegisterTokenExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error) *UserEventbusServiceHandlerMock {
...
func (mmSecurityRegisterToken *UserEventbusServiceHandlerMock) SecurityRegisterToken(ctx context.Context, pp1 *connect_go.Request[v1.UserSecurityEvent]) (pp2 *connect_go.Response[v1.UserEventbusSecurityRegisterTokenResponse], err error) {
...
type UserEventbusServiceHandlerMockUserChangeResults struct {
	pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse]
	err error
}
...
func (mmUserChange *mUserEventbusServiceHandlerMockUserChange) Return(pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error) *UserEventbusServiceHandlerMock {
	if mmUserChange.mock.funcUserChange != nil {
		mmUserChange.mock.t.Fatalf("UserEventbusServiceHandlerMock.UserChange mock is already set by Set")
	}
...
func (mmUserChange *mUserEventbusServiceHandlerMockUserChange) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.UserChangeEvent]) (pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error)) *UserEventbusServiceHandlerMock {
	if mmUserChange.defaultExpectation != nil {
...
func (e *UserEventbusServiceHandlerMockUserChangeExpectation) Then(pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error) *UserEventbusServiceHandlerMock {
	e.results = &UserEventbusServiceHandlerMockUserChangeResults{pp2, err}
	return e.mock
}

// UserChange implements UserEventbusServiceHandler
func (mmUserChange *UserEventbusServiceHandlerMock) UserChange(ctx context.Context, pp1 *connect_go.Request[v1.UserChangeEvent]) (pp2 *connect_go.Response[v1.UserEventbusUserChangeResponse], err error) {
