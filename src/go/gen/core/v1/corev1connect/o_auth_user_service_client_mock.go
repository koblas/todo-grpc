...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.OAuthUserServiceClient -o ./o_auth_user_service_client_mock.go -n OAuthUserServiceClientMock
