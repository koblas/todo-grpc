...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.AuthUserServiceHandler -o ./auth_user_service_handler_mock_test.go -n AuthUserServiceHandlerMock
