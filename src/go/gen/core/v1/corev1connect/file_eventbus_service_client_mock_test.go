...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/v1/corev1connect.FileEventbusServiceClient -o ./file_eventbus_service_client_mock_test.go -n FileEventbusServiceClientMock
...
func (mmFileComplete *mFileEventbusServiceClientMockFileComplete) Expect(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceCompleteEvent]) *mFileEventbusServiceClientMockFileComplete {
...
func (mmFileComplete *mFileEventbusServiceClientMockFileComplete) Inspect(f func(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceCompleteEvent])) *mFileEventbusServiceClientMockFileComplete {
...
func (mmFileComplete *mFileEventbusServiceClientMockFileComplete) Return(pp2 *connect_go.Response[v1.FileEventbusFileCompleteResponse], err error) *FileEventbusServiceClientMock {
	if mmFileComplete.mock.funcFileComplete != nil {
		mmFileComplete.mock.t.Fatalf("FileEventbusServiceClientMock.FileComplete mock is already set by Set")
	}
...
func (mmFileComplete *mFileEventbusServiceClientMockFileComplete) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceCompleteEvent]) (pp2 *connect_go.Response[v1.FileEventbusFileCompleteResponse], err error)) *FileEventbusServiceClientMock {
	if mmFileComplete.defaultExpectation != nil {
...
// Then helper
func (mmFileComplete *mFileEventbusServiceClientMockFileComplete) When(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceCompleteEvent]) *FileEventbusServiceClientMockFileCompleteExpectation {
	if mmFileComplete.mock.funcFileComplete != nil {
		mmFileComplete.mock.t.Fatalf("FileEventbusServiceClientMock.FileComplete mock is already set by Set")
	}
...
func (e *FileEventbusServiceClientMockFileCompleteExpectation) Then(pp2 *connect_go.Response[v1.FileEventbusFileCompleteResponse], err error) *FileEventbusServiceClientMock {
	e.results = &FileEventbusServiceClientMockFileCompleteResults{pp2, err}
	return e.mock
}

// FileComplete implements FileEventbusServiceClient
func (mmFileComplete *FileEventbusServiceClientMock) FileComplete(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceCompleteEvent]) (pp2 *connect_go.Response[v1.FileEventbusFileCompleteResponse], err error) {
...
func (mmFileUploaded *mFileEventbusServiceClientMockFileUploaded) Expect(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceUploadEvent]) *mFileEventbusServiceClientMockFileUploaded {
...
func (mmFileUploaded *mFileEventbusServiceClientMockFileUploaded) Inspect(f func(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceUploadEvent])) *mFileEventbusServiceClientMockFileUploaded {
...
func (mmFileUploaded *mFileEventbusServiceClientMockFileUploaded) Return(pp2 *connect_go.Response[v1.FileEventbusFileUploadedResponse], err error) *FileEventbusServiceClientMock {
	if mmFileUploaded.mock.funcFileUploaded != nil {
		mmFileUploaded.mock.t.Fatalf("FileEventbusServiceClientMock.FileUploaded mock is already set by Set")
	}
...
func (mmFileUploaded *mFileEventbusServiceClientMockFileUploaded) Set(f func(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceUploadEvent]) (pp2 *connect_go.Response[v1.FileEventbusFileUploadedResponse], err error)) *FileEventbusServiceClientMock {
	if mmFileUploaded.defaultExpectation != nil {
...
// Then helper
func (mmFileUploaded *mFileEventbusServiceClientMockFileUploaded) When(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceUploadEvent]) *FileEventbusServiceClientMockFileUploadedExpectation {
	if mmFileUploaded.mock.funcFileUploaded != nil {
		mmFileUploaded.mock.t.Fatalf("FileEventbusServiceClientMock.FileUploaded mock is already set by Set")
	}
...
func (e *FileEventbusServiceClientMockFileUploadedExpectation) Then(pp2 *connect_go.Response[v1.FileEventbusFileUploadedResponse], err error) *FileEventbusServiceClientMock {
	e.results = &FileEventbusServiceClientMockFileUploadedResults{pp2, err}
	return e.mock
}

// FileUploaded implements FileEventbusServiceClient
func (mmFileUploaded *FileEventbusServiceClientMock) FileUploaded(ctx context.Context, pp1 *connect_go.Request[v1.FileServiceUploadEvent]) (pp2 *connect_go.Response[v1.FileEventbusFileUploadedResponse], err error) {
