...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/file/v1/filev1connect.FileServiceClient -o ./file_service_client_mock.go -n FileServiceClientMock
