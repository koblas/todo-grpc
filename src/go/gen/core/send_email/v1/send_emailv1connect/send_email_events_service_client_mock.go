...
//go:generate minimock -i github.com/koblas/grpc-todo/gen/core/send_email/v1/send_emailv1connect.SendEmailEventsServiceClient -o ./send_email_events_service_client_mock.go -n SendEmailEventsServiceClientMock
