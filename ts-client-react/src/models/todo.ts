...
export const getTodoParams = {
  encode(_: getTodoParams, writer: Writer = Writer.create()): Writer {
    return writer;
  },

  decode(input: Reader | Uint8Array, length?: number): getTodoParams {
...
export const addTodoParams = {
  encode(message: addTodoParams, writer: Writer = Writer.create()): Writer {
    if (message.task !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): addTodoParams {
    const reader = input instanceof Reader ? input : new Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const deleteTodoParams = {
  encode(message: deleteTodoParams, writer: Writer = Writer.create()): Writer {
    if (message.id !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): deleteTodoParams {
    const reader = input instanceof Reader ? input : new Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const todoObject = {
  encode(message: todoObject, writer: Writer = Writer.create()): Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.task !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): todoObject {
    const reader = input instanceof Reader ? input : new Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const todoResponse = {
  encode(message: todoResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): todoResponse {
    const reader = input instanceof Reader ? input : new Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
